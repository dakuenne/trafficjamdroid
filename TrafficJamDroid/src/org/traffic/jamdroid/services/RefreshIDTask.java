...
/**
 * Task to refresh the id of the client.
 * 
 * @author Daniel Kuenne
 * @version $LastChangedRevision: 226 $
 */
public class RefreshIDTask extends AsyncTask<Context, Void, Void> {

	@Override
	protected Void doInBackground(Context... params) {
		try {
			Thread.sleep(10000);
			final Request reqId = new Request(IConstants.REQUEST_REFRESH_ID,
					Preferences.getInstance(params[0].getApplicationContext())
			...
			Log.e("RefreshIDTask", ex.getClass().getSimpleName()
